...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    protected function executeInstall(): bool
    {
        ...
        $rows = [
            ['Installed version', 'PLUGIN_PRODUCTS_REVIEW_REMINDER_VERSION', '2.0.1', 'Installed plugin version.', 0, "zen_cfg_select_option(array('2.0.1'),"],
            ...
            ['Eligible date window', 'REVIEWS_REMINDER_WINDOW_DAYS', '30', 'Only include orders that became eligible within this many days.', 30, null],
            ...
            ['Email subject', 'REVIEWS_REMINDER_EMAIL_SUBJECT', '{customer_name}, how did your recent order from {store_name} work out?', 'Available tokens: {customer_name}, {store_name}, {order_number}.', 50, null],
            ['Email greeting', 'REVIEWS_REMINDER_EMAIL_GREETING', 'Hello {customer_name},', 'Opening line of the review request.', 60, null],
            ['Email introduction', 'REVIEWS_REMINDER_EMAIL_INTRO', 'Thank you for shopping with {store_name}. We would appreciate your honest feedback about your purchase.', 'Text shown before the products.', 70, null],
            ['Product question', 'REVIEWS_REMINDER_EMAIL_QUESTION', 'How did this item meet your expectations?', 'Question shown with each product.', 80, null],
            ['Review link text', 'REVIEWS_REMINDER_EMAIL_CTA', 'Rate and review this item', 'Linked call to action shown with each product.', 90, null],
            ['Email closing', 'REVIEWS_REMINDER_EMAIL_CLOSING', 'Thank you for taking the time to share your experience.', 'Text shown after the products.', 100, null],
        ];
        ...
        $this->executeInstallerSql('UPDATE ' . TABLE_CONFIGURATION . " SET configuration_value = '2.0.1', set_function = 'zen_cfg_select_option(array(\\'2.0.1\\'),' WHERE configuration_key = 'PLUGIN_PRODUCTS_REVIEW_REMINDER_VERSION'");
