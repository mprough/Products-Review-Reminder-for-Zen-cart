...
<?php
	...
	function get_request_for_review_content($oid, $limit_products, $mailto, $customer_name, $customer_id, $is_test = false, $live_optout_test = false){
		...
		$question = products_review_reminder_decode_text(defined('REVIEWS_REMINDER_EMAIL_QUESTION') ? REVIEWS_REMINDER_EMAIL_QUESTION : EMAIL_EXPECTATION_QUESTION);
		$cta = products_review_reminder_decode_text(defined('REVIEWS_REMINDER_EMAIL_CTA') ? REVIEWS_REMINDER_EMAIL_CTA : EMAIL_ACTION_CALL);
