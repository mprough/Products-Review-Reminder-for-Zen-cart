...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    protected function executeInstall(): bool
    {
        ...
        $rows = [
            ['Installed version', 'PLUGIN_PRODUCTS_REVIEW_REMINDER_VERSION', '2.0.10', 'Installed plugin version.', 0, "zen_cfg_select_option(array('2.0.10'),"],
        ...
        $this->executeInstallerSql('UPDATE ' . TABLE_CONFIGURATION . " SET configuration_value = '2.0.10', set_function = 'zen_cfg_select_option(array(\\'2.0.10\\'),' WHERE configuration_key = 'PLUGIN_PRODUCTS_REVIEW_REMINDER_VERSION'");
