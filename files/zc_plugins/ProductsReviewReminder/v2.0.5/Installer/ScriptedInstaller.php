...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    protected function executeInstall(): bool
    {
        ...
        $rows = [
            ['Installed version', 'PLUGIN_PRODUCTS_REVIEW_REMINDER_VERSION', '2.0.5', 'Installed plugin version.', 0, "zen_cfg_select_option(array('2.0.5'),"],
            ...
            ['Email subject', 'REVIEWS_REMINDER_EMAIL_SUBJECT', '{customer_name}, how did your recent order from {store_name} work out?', 'Available tokens: {customer_name}, {store_name}, {order_number}.', 50, 'zen_cfg_textarea('],
            ['Email greeting', 'REVIEWS_REMINDER_EMAIL_GREETING', 'Hello {customer_name},', 'Opening text of the review request. Available tokens: {customer_name}, {store_name}, {order_number}.', 60, 'zen_cfg_textarea('],
            ['Email introduction', 'REVIEWS_REMINDER_EMAIL_INTRO', 'Thank you for shopping with {store_name}. We would appreciate your honest feedback about your purchase.', 'Text shown before the products. Available tokens: {customer_name}, {store_name}, {order_number}.', 70, 'zen_cfg_textarea('],
            ...
            ['Email closing', 'REVIEWS_REMINDER_EMAIL_CLOSING', 'Thank you for taking the time to share your experience.', 'Text shown after the products. Available tokens: {customer_name}, {store_name}, {order_number}.', 100, 'zen_cfg_textarea('],
        ];
        ...
        $this->executeInstallerSql('UPDATE ' . TABLE_CONFIGURATION . " SET configuration_value = '2.0.5', set_function = 'zen_cfg_select_option(array(\\'2.0.5\\'),' WHERE configuration_key = 'PLUGIN_PRODUCTS_REVIEW_REMINDER_VERSION'");
