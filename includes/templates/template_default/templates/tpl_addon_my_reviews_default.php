...
<?php
			while(!$rec->EOF){
				...
				if( $rating ){
					...
					for($i=0; $i < $rating; $i++){
						$rating_stars .= '<img src="' . DIR_WS_TEMPLATE . 'images/rating_star_on.png" />' . "\n";
					}
					for( $i; $i < 5; $i++ ){
						$rating_stars .= '<img src="' . DIR_WS_TEMPLATE . 'images/rating_star.png" />' . "\n";
					}
					...
					$rating_stars = '<div id="' . $pid . '-stars">
						<img src="' . DIR_WS_TEMPLATE . 'images/rating_star.png" id="' . $pid . '-' . '1" onmouseover="show_rating(' . $pid . ', 1);" onmouseout="hide_rating(\'' . $pid . '\');" onclick="update_rating(\'' . $pid . '\', 1);" />
						
						<img src="' . DIR_WS_TEMPLATE . 'images/rating_star.png" id="' . $pid . '-' . '2" onmouseover="show_rating(' . $pid . ', 2);" onmouseout="hide_rating(\'' . $pid . '\');" onclick="update_rating(\'' . $pid . '\', 2);" />
						
						<img src="' . DIR_WS_TEMPLATE . 'images/rating_star.png" id="' . $pid . '-' . '3" onmouseover="show_rating(' . $pid . ', 3);" onmouseout="hide_rating(\'' . $pid . '\');" onclick="update_rating(\'' . $pid . '\', 3);" />
						
						<img src="' . DIR_WS_TEMPLATE . 'images/rating_star.png" id="' . $pid . '-' . '4" onmouseover="show_rating(' . $pid . ', 4);" onmouseout="hide_rating(\'' . $pid . '\');" onclick="update_rating(\'' . $pid . '\', 4);" />
						
						<img src="' . DIR_WS_TEMPLATE . 'images/rating_star.png" id="' . $pid . '-' . '5" onmouseover="show_rating(' . $pid . ', 5);" onmouseout="hide_rating(\'' . $pid . '\');" onclick="update_rating(\'' . $pid . '\', 5);" />
...
?>
				<tr<?php if($rating) echo ' class="reviewed-item"'; ?>>
					<td class="product_image">
						...
						<?php if( $review != '' ) echo '<div class="txt-review" id="txt-review-' . $pid . '">' . $review . '</div>'; ?>
